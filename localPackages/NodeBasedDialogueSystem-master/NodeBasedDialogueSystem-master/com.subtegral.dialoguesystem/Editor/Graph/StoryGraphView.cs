...
namespace Subtegral.DialogueSystem.Editor
{
    public class StoryGraphView : GraphView
    {
        ...
        {
            AddElement(CreateNode(nodeName, "Character Name", position));
        }

        public DialogueNode CreateNode(string nodeName, string characterName, Vector2 position)
        {
            ...
            {
                tempDialogueNode.Name = evt.newValue;
                tempDialogueNode.title = evt.newValue;
            });
            nameField.SetValueWithoutNotify(tempDialogueNode.Name);
            tempDialogueNode.mainContainer.Add(nameField);
